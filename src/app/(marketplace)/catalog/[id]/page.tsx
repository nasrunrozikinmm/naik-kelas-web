              ...
              <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-primary text-white p-6 rounded-2xl relative overflow-hidden shadow-md">
                  <div className="relative z-10 space-y-3">
                    ...
                    <Link
                      href={`/chat?recipient=${catalog.talent_profile_id || catalog.id}`}
                      className="inline-flex items-center justify-center w-full py-2.5 px-4 bg-surface-container-lowest !text-primary font-bold text-xs rounded-xl shadow-xs hover:bg-surface active:scale-95 transition-all text-center"
                    >
