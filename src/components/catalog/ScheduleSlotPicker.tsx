...
export function ScheduleSlotPicker({
  ...
  const handleRemoveSlot = (index: number) => {
    onChange(activeSlots.filter((_, i) => i !== index));
  };
  ...
  return (
    <div className="space-y-4">
      {!readOnly && (
        <div className="p-4 bg-surface-container-low rounded-2xl border border-outline-variant/40 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-surface text-xs text-on-surface border border-outline-variant/40 rounded-[10px] focus:ring-2 focus:ring-primary/20 focus:outline-hidden"
              />
            </div>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-primary text-white rounded-[10px] text-xs font-bold hover:bg-primary/90 transition-colors shadow-xs"
          >
      ...
      {activeSlots.length === 0 ? (
        <div className="p-4 text-center border border-dashed border-outline-variant/50 rounded-2xl">
        ...
        <div className="space-y-2">
          <p className="text-xs font-bold text-on-surface">
            Daftar Slot Tersedia ({activeSlots.length} sesi):
          </p>
